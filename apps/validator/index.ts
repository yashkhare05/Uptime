...
function convertBase58ToUint8Array(base58String: string): Uint8Array {
    return bs58.decode(base58String);
}

async function main() {
    const keypair = Keypair.fromSecretKey(
        convertBase58ToUint8Array("52JRHQUGtojyvUQDSi3VjF4pAiQEFBYpKeGUqS3tdSZnP4vbmAPZP4Y3TVEAKY8JScakkGeGnUtmDHznBHgQCWZk")
    );
